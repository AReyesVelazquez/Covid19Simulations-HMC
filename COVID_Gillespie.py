...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 25 18:13:56 2022
...
def Simulation():
    ...
    while t < t_stop:
        ...
        if Daychange[t_day] == 0:
            ...
            Daychange[t_day] = 1
        # Variants triggers
        if t_day >= 344 and alph != 1:
            bin_prob[0]  = 3.627
            bin_prob[1]  = 0.063*3.627
            bin_prob[2]  = 0.15*3.627
            Rates[0] = mono_prob[0]/3.0
            alph += 1
        if t_day >= 430 and delt != 1:
            bin_prob[0]  = 5.08
            bin_prob[1]  = 0.12*5.08
            bin_prob[2]  = 0.15*5.08
            Rates[0] = mono_prob[0]/4.0
            delt += 1
        if t_day >= 700 and omic != 1:
            bin_prob[0]  = 16.205
